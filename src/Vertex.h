...
class vert {
  public:
	...
	inline operator point2() const {
		return texture();
	}
	inline operator point2() {
		return texture();
	}
	...
	inline operator point4() const {
		return screen();
	}
	inline operator point4() {
		return screen();
	}

	// Accessors

	inline const point2 &texture() const {
		return _texture;
	}
	inline point2 &texture() {
		return _texture;
	}
	inline const point3 &world() const {
		return _world;
	}
	inline point3 &world() {
		return _world;
	}
	inline const point4 &screen() const {
		return _screen;
	}
	inline point4 &screen() {
		return _screen;
	}
