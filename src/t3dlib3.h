...
#define MAX_SOUNDS 1024 // max number of sounds in system at once
...
// directsound
int DSound_Load_WAV(char *filename, int control_flags = DSBCAPS_CTRLPAN | DSBCAPS_CTRLVOLUME | DSBCAPS_CTRLFREQUENCY);
